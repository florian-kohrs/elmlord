						...
						return function (event) {
							return function (playersTurn) {
								return function (playerInput) {
									return function (volumne) {
										return {date: date, errorMsg: errorMsg, event: event, gameState: gameState, lords: lords, map: map, playerInput: playerInput, playersTurn: playersTurn, selectedPoint: selectedPoint, volumne: volumne};
									};
								};
							};
						};
...
var $author$project$AI$AI = F2(
	function (lord, strategy) {
		return {lord: lord, strategy: strategy};
	});
var $author$project$AI$ActionMultipliers = F5(
	function (siegeMultiplier, defendMultiplier, battleMultiplier, growArmyMultiplier, improveSettlements) {
		return {battleMultiplier: battleMultiplier, defendMultiplier: defendMultiplier, growArmyMultiplier: growArmyMultiplier, improveSettlements: improveSettlements, siegeMultiplier: siegeMultiplier};
	});
var $author$project$AI$getAiActionMultiplier = function (f) {
	return 1 + ($elm$core$Basics$sin((2 * $elm$core$Basics$pi) * f) / 3);
};
var $author$project$Main$initAI = F2(
	function (l, i) {
		return A2(
			$author$project$AI$AI,
			l,
			A5(
				$author$project$AI$ActionMultipliers,
				$author$project$AI$getAiActionMultiplier(0.7) + (i / 5),
				$author$project$AI$getAiActionMultiplier(0.3) + (i / 7),
				$author$project$AI$getAiActionMultiplier(0.5) + (i / 3),
				$author$project$AI$getAiActionMultiplier(0.7) + (i / 5),
				$author$project$AI$getAiActionMultiplier(0.9) + (i / 7)));
	});
...
var $author$project$Entities$Model$aiNames = _List_fromArray(
	['', 'Jan von Haskell', 'Herzog K. Willi', 'Sir Quicknuss']);
...
var $author$project$Main$initPlayers = F2(
	function (m, count) {
		return A2(
			...
			A3($author$project$Main$initPlayer, m, 0, 2 * 0.125),
			A2(
				$elm$core$List$map,
				function (i) {
					return A2(
						$author$project$Main$initAI,
						A3($author$project$Main$initPlayer, m, i, 2 * ((i / count) + 0.125)),
						i);
				},
				A2($elm$core$List$range, 1, count - 1)));
	});
var $author$project$Main$initialModel = function (playerCount) {
	var map = $author$project$MapGenerator$createMap;
	return $author$project$Main$Model(
		A2($author$project$Main$initPlayers, map, playerCount))(
...
var $author$project$Main$endAnyRound = function (m) {
	return ((m.playersTurn + 1) >= 4) ? _Utils_update(
		m,
...
var $author$project$Event$appendEvent = F4(
	function (l, h, t, e) {
		return A2(
			$elm$core$List$cons,
			{
...
var $author$project$AI$AiRoundActionPreference = F2(
	function (action, actionValue) {
		return {action: action, actionValue: actionValue};
	});
var $author$project$AI$EndRound = {$: 'EndRound'};
var $author$project$AI$DoSomething = function (a) {
	return {$: 'DoSomething', a: a};
};
var $author$project$AI$SiegeSettlement = function (a) {
	return {$: 'SiegeSettlement', a: a};
};
var $author$project$Balancing$distanceFromAggresiveActionPenalty = function (turns) {
	return turns * 0.1;
};
...
var $author$project$Balancing$settlementDefenseBoni = F2(
	function (s, landlord) {
		var _v0 = s.settlementType;
		if (_v0.$ === 'Village') {
			return 0.1;
		} else {
			return ($elm$core$List$length(landlord.land) - 1) * 0.15;
		}
	});
...
var $author$project$Troops$sumTroopStats = A2(
	$elm$core$Dict$foldl,
	F3(
		function (k, v, r) {
			return ($elm$core$Basics$round(
				$author$project$Troops$troopDamage(
					$author$project$Troops$intToTroopType(k)) + $author$project$Troops$troopDefense(
					$author$project$Troops$intToTroopType(k))) * v) + r;
		}),
	0);
var $author$project$AI$entityStrength = function (e) {
	return $author$project$Troops$sumTroopStats(e.army);
};
var $author$project$AI$settlementDefenseStrength = F3(
	function (ai, s, enemies) {
		var settlementDefense = $elm$core$Basics$round(
			$author$project$AI$entityStrength(s.entity));
		var _v0 = A2($author$project$Entities$landlordOnSettlement, s, enemies);
		if (_v0.$ === 'Nothing') {
			return settlementDefense;
		} else {
			var l = _v0.a;
			return $elm$core$Basics$round(
				$author$project$AI$entityStrength(l.entity)) + settlementDefense;
		}
	});
var $author$project$AI$evaluateSettlementSiegeAction = F4(
	function (ai, s, turnsTillReached, ls) {
		var siegeStrengthDiff = $author$project$Troops$sumTroopStats(ai.lord.entity.army) / (A3($author$project$AI$settlementDefenseStrength, ai, s, ls) * A3(
			$author$project$MaybeExt$foldMaybe,
			function (l) {
				return 1 + A2($author$project$Balancing$settlementDefenseBoni, s, l);
			},
			1,
			A2($author$project$Entities$landlordOnSettlement, s, ls)));
		return (siegeStrengthDiff >= 1) ? $elm$core$Maybe$Just(
			A2(
				$author$project$AI$AiRoundActionPreference,
				$author$project$AI$DoSomething(
					$author$project$AI$SiegeSettlement(s)),
				(siegeStrengthDiff * ai.strategy.siegeMultiplier) - $author$project$Balancing$distanceFromAggresiveActionPenalty(turnsTillReached))) : $elm$core$Maybe$Nothing;
	});
var $author$project$ListExt$justList = A2(
	...
	_List_Nil);
var $author$project$AI$getSettlementAttackActions = F3(
	function (ai, getTurnsToPoint, enemies) {
				...
				F2(
					function (s, r) {
						return A2(
							$elm$core$List$cons,
							A4(
								$author$project$AI$evaluateSettlementSiegeAction,
								ai,
								s,
								A2(getTurnsToPoint, ai.lord, s.entity.position),
								enemies),
							r);
					}),
				_List_Nil,
...
var $author$project$AI$SwapTroops = F2(
	function (a, b) {
		return {$: 'SwapTroops', a: a, b: b};
	});
var $author$project$Balancing$acceptedSettlementLackOfDefense = 0.1;
var $elm$core$Basics$pow = _Basics_pow;
var $author$project$AI$evaluateSettlementDefense = F2(
	function (ai, settlementDefenseRating) {
		return ((settlementDefenseRating.armyStrengthVariance + ($author$project$Balancing$acceptedSettlementLackOfDefense / ai.strategy.defendMultiplier)) >= 1) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			A2(
				$author$project$AI$AiRoundActionPreference,
				$author$project$AI$DoSomething(
					A2($author$project$AI$SwapTroops, $elm$core$Dict$empty, settlementDefenseRating.settlement)),
				A2($elm$core$Basics$pow, settlementDefenseRating.armyStrengthVariance, -1) * ai.strategy.defendMultiplier));
	});
var $author$project$AI$SettlmentDefenseRating = F2(
	function (settlement, armyStrengthVariance) {
		return {armyStrengthVariance: armyStrengthVariance, settlement: settlement};
	});
...
var $author$project$AI$estimatedNormalCastleTroopStrength = function (l) {
	var x = $author$project$Entities$lordSettlementCount(l);
	return 400 * ((1 / x) + ((1 - (1 / x)) / (((x * x) * 0.01) + 1)));
};
var $author$project$AI$estimatedNormalVillageTroopStrength = function (l) {
	return 250;
};
var $author$project$AI$rateSettlementDefense = F3(
	function (lord, strength, entityType) {
		if (entityType.$ === 'Village') {
			return strength / $author$project$AI$estimatedNormalVillageTroopStrength(lord);
		} else {
			return strength / $author$project$AI$estimatedNormalCastleTroopStrength(lord);
		}
	});
var $author$project$AI$settlementDefenseArmyRating = function (l) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (s, r) {
				return A2(
					$elm$core$List$cons,
					A2(
						$author$project$AI$SettlmentDefenseRating,
						s,
						A3(
							$author$project$AI$rateSettlementDefense,
							l,
							$author$project$Troops$sumTroopStats(s.entity.army),
							s.settlementType)),
					r);
			}),
		_List_Nil,
...
var $author$project$AI$getSettlementDefenseActions = F3(
	function (ai, getTurnsToPoint, enemies) {
		return $author$project$ListExt$justList(
			A3(
				$elm$core$List$foldl,
				F2(
					function (s, r) {
						return A2(
							$elm$core$List$cons,
							A2($author$project$AI$evaluateSettlementDefense, ai, s),
							r);
					}),
				_List_Nil,
				$author$project$AI$settlementDefenseArmyRating(ai.lord)));
	});
var $author$project$PathAgent$remainingMovement = function (a) {
	return a.speed - a.usedMovement;
};
var $author$project$AI$getAiActions = F3(
	function (ai, getTurnsToPoint, enemies) {
		var ownSettlementDefenseActions = A3($author$project$AI$getSettlementDefenseActions, ai, getTurnsToPoint, enemies);
		var enemySettlementStates = A3($author$project$AI$getSettlementAttackActions, ai, getTurnsToPoint, enemies);
		return (!$author$project$PathAgent$remainingMovement(ai.lord.agent)) ? _List_Nil : enemySettlementStates;
	});
var $author$project$AI$getBasicActionDestination = function (basicAction) {
	switch (basicAction.$) {
		case 'AttackLord':
			var l = basicAction.a;
...
var $author$project$AI$getAiRoundActionDestination = function (a) {
	switch (a.$) {
		case 'EndRound':
			return $elm$core$Maybe$Nothing;
		case 'GoSomeWhere':
		...
		default:
			var basicAction = a.a;
			return $elm$core$Maybe$Just(
				$author$project$AI$getBasicActionDestination(basicAction));
	}
};
	...
	function (ai, distanceTo, canMoveInTurn, enemies) {
		var _v0 = $elm$core$List$head(
			A2(
				...
				A2(
					$elm$core$List$cons,
					A2($author$project$AI$AiRoundActionPreference, $author$project$AI$EndRound, 0.0),
					A3($author$project$AI$getAiActions, ai, distanceTo, enemies))));
		if (_v0.$ === 'Nothing') {
			return $author$project$AI$EndRound;
		} else {
			var action = _v0.a;
			var _v1 = $author$project$AI$getAiRoundActionDestination(action.action);
			if (_v1.$ === 'Nothing') {
				return $author$project$AI$EndRound;
			} else {
				var p = _v1.a;
				return A2(canMoveInTurn, ai.lord, p) ? action.action : $author$project$AI$EndRound;
			}
		}
	});
...
var $author$project$PathAgent$lordsTurnToReachDestination = F3(
	function (m, l, p) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var path = _v0.a;
			return A2($author$project$PathAgent$roundsToFinishPath, l.agent, path.path);
		}
	});
...
var $author$project$Event$setEvents = F2(
	function (eventState, eventList) {
		return _Utils_update(
			eventState,
			{events: eventList});
	});
...
var $author$project$AI$showBasicAction = function (basicAction) {
	switch (basicAction.$) {
		case 'AttackLord':
			return 'Attack Lord';
		case 'HireTroops':
			var intTroopTypeTroopsDictDict = basicAction.a;
			var settlementModelEntities = basicAction.b;
			return 'Hire Troops';
		case 'SwapTroops':
			var intTroopTypeTroopsDictDict = basicAction.a;
			var settlementModelEntities = basicAction.b;
			return 'Swap Troops';
		case 'SiegeSettlement':
			var settlementModelEntities = basicAction.a;
			return 'Siege Settlement: ' + settlementModelEntities.entity.name;
		default:
			var settlementModelEntities = basicAction.a;
			var buildingBuilding = basicAction.b;
			return 'Improve Building';
	}
};
var $author$project$Vector$showPoint = function (p) {
	return '(' + ($elm$core$String$fromInt(p.x) + (', ' + ($elm$core$String$fromInt(p.y) + ')')));
};
var $author$project$AI$showAiRoundAction = function (aiRoundActions) {
	switch (aiRoundActions.$) {
		case 'EndRound':
			return 'End Round';
		case 'GoSomeWhere':
			var p = aiRoundActions.a;
			return 'Go to ' + $author$project$Vector$showPoint(p);
		default:
			var basicAction = aiRoundActions.a;
			return $author$project$AI$showBasicAction(basicAction);
	}
};
var $author$project$AI$executeBasicAiAction = F3(
	function (ai, action, moveTowards) {
		if (action.$ === 'SiegeSettlement') {
			var s = action.a;
			var movedAI = _Utils_update(
				ai,
				{
					lord: A2(moveTowards, ai.lord, s.entity.position)
				});
			return _Utils_eq(movedAI.lord.entity.position, s.entity.position) ? movedAI : movedAI;
		} else {
			return ai;
		}
	});
var $author$project$AI$updateAi = F3(
	function (ai, action, moveTowards) {
		switch (action.$) {
			case 'EndRound':
				return ai;
			...
			default:
				...
				return A3($author$project$AI$executeBasicAiAction, ai, basicAction, moveTowards);
		}
	});
	...
	if (_v0.$ === 'Nothing') {
		...
		if (action.$ === 'EndRound') {
			...
			return _Utils_update(
				...
				{
					event: A2(
						$author$project$Event$setEvents,
						m.event,
						A4(
							$author$project$Event$appendEvent,
							m.event.events,
							ai.lord.entity.name,
							$author$project$AI$showAiRoundAction(other),
...
var $author$project$Main$filterDefeatedLord = F3(
	function (k, d, ais) {
		return k ? A2(
			$elm$core$List$filter,
			function (x) {
				return !_Utils_eq(x.lord.entity.name, d.entity.name);
			},
			ais) : A2(
			$elm$core$List$map,
			function (ai) {
				return A3(
					...
					_Utils_eq(ai.lord.entity.name, d.entity.name),
					A2($author$project$AI$setLord, ai, d),
					ai);
			},
			ais);
	});
...
var $author$project$Balancing$addGoldCastle = 500.00;
var $author$project$Battle$getGoldBonus = function (lord) {
	return _Utils_update(
		lord,
		{gold: lord.gold + $author$project$Balancing$addGoldCastle});
};
...
var $author$project$Battle$siegeBattleAftermath = F2(
	function (bS, s) {
		...
		return ($author$project$Troops$sumTroops(s.entity.army) <= 0) ? (_Utils_eq(s.settlementType, $author$project$Entities$Model$Castle) ? A4(
			...
			$author$project$Battle$getGoldBonus(attacker),
			defender,
			function (y) {
...
var $author$project$Main$updateLordsAfterBattle = F4(
	function (player, enemyLords, model, state) {
		return _Utils_update(
			...
			{
				gameState: state,
				lords: A2($author$project$Entities$Lords$Cons, player, enemyLords)
			});
	});
var $author$project$Main$checkBattleAftermath = F2(
	function (model, bS) {
		...
		if (_v0.$ === 'Nothing') {
			return A4(
				...
				A2(
					...
					function (ai) {
						return A3(
							$author$project$OperatorExt$ternary,
							_Utils_eq(ai.lord.entity.name, bS.defender.entity.name),
							A2($author$project$AI$setLord, ai, bS.defender),
							ai);
					},
			...
			var settle = _v0.a;
			var _v1 = A2($author$project$Battle$siegeBattleAftermath, bS, settle);
			var newAttacker = _v1.a;
			var newDefender = _v1.b;
			var lordKilled = _v1.c;
			var newEnemyLords = A3(
				$author$project$Main$filterDefeatedLord,
				lordKilled,
				newDefender,
				$author$project$Entities$Lords$getAis(model.lords));
			return A4(
				...
				A3(
					...
					$elm$core$List$length(
						$author$project$Entities$Lords$npcs(model.lords)) > 0,
					$author$project$Main$GameSetup($author$project$Main$GameMenue),
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'FleeBattle':
				var bS = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$checkBattleAftermath, model, bS),
...
var $author$project$Entities$changeEntitiyName = F2(
	function (name, we) {
		return _Utils_update(
			we,
			{name: name});
	});
var $author$project$Entities$changeLordName = F2(
	function (name, lord) {
		return _Utils_update(
			lord,
			{
				entity: A2($author$project$Entities$changeEntitiyName, name, lord.entity)
			});
	});
...
var $author$project$Ports$updateVolumne = _Platform_outgoingPort('updateVolumne', $elm$json$Json$Encode$int);
					...
					_Utils_update(
						model,
						{
							...
							lords: A2(
								...
								model.lords,
								A2(
									$author$project$Entities$changeLordName,
									name,
									$author$project$Main$getPlayer(model)))
						}),
			...
			case 'ChangeVolumne':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{volumne: vol}),
					$author$project$Ports$updateVolumne(vol));
			case 'ShowMenue':
				return $author$project$Main$emptyCmd(
					_Utils_update(
						model,
...
var $author$project$Main$buildMapActionTemplate = F2(
	function (model, allClickActions) {
		if ($author$project$Main$isPlayersTurn(model)) {
			return A2($author$project$Templates$MapActionTemplate$generateMapActionTemplate, model.selectedPoint, allClickActions);
		} else {
			var lordName = A3(
				$author$project$MaybeExt$foldMaybe,
				function (l) {
...
var $author$project$Msg$ChangeVolumne = function (a) {
	return {$: 'ChangeVolumne', a: a};
};
...
var $author$project$Templates$HeaderTemplate$resolveOnChangeMsg = function (str) {
	return $author$project$Msg$MenueAction(
		$author$project$Msg$ChangeVolumne(
			A2(
				$elm$core$Maybe$withDefault,
				0,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											'Current volumne: ' + ($elm$core$String$fromInt(vol) + '%'))
										]))
								]))
						]))
				])),
