...
var $author$project$Main$Model = function (lords) {
				...
				return function (map) {
					return function (errorMsg) {
						return function (event) {
							return function (playersTurn) {
								return function (playerInput) {
									return function (volume) {
										return {date: date, errorMsg: errorMsg, event: event, gameState: gameState, lords: lords, map: map, playerInput: playerInput, playersTurn: playersTurn, selectedPoint: selectedPoint, volume: volume};
									};
								};
							};
						};
...
var $author$project$MapGenerator$createMap = function (seed) {
...
var $author$project$Main$hashString = function (s) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (c, _v0) {
...
var $author$project$Entities$Model$aiNames = _List_fromArray(
	['', 'Baron Bodo', 'Herzog K. Willi', 'Sir Quicknuss']);
...
var $author$project$ListExt$getElementAt = F2(
	function (i, l) {
		return (i <= 0) ? $elm$core$List$head(l) : A2(
			...
			$author$project$ListExt$getElementAt(i - 1),
			$elm$core$List$tail(l));
	});
var $author$project$AI$Model$AI = F2(
	function (lord, strategy) {
		return {lord: lord, strategy: strategy};
	});
var $author$project$AI$Model$ActionMultipliers = F5(
	function (siegeMultiplier, defendMultiplier, battleMultiplier, growArmyMultiplier, improveSettlementsMultiplier) {
		return {battleMultiplier: battleMultiplier, defendMultiplier: defendMultiplier, growArmyMultiplier: growArmyMultiplier, improveSettlementsMultiplier: improveSettlementsMultiplier, siegeMultiplier: siegeMultiplier};
	});
var $author$project$AI$getAiActionMultiplier = function (f) {
	return 1 + ($elm$core$Basics$sin($elm$core$Basics$pi * f) / 3);
};
var $author$project$Entities$Model$playerCount = 4;
var $author$project$Main$initAI = F3(
	function (l, i, offset) {
		return A2(
			$author$project$AI$Model$AI,
			l,
			A5(
				$author$project$AI$Model$ActionMultipliers,
				$author$project$AI$getAiActionMultiplier((offset + 0.3) + ((2 * i) / $author$project$Entities$Model$playerCount)),
				$author$project$AI$getAiActionMultiplier((offset + 0.7) + ((2 * i) / $author$project$Entities$Model$playerCount)),
				$author$project$AI$getAiActionMultiplier((offset + 1) + ((2 * i) / $author$project$Entities$Model$playerCount)),
				$author$project$AI$getAiActionMultiplier((offset + 1.3) + ((2 * i) / $author$project$Entities$Model$playerCount)),
				$author$project$AI$getAiActionMultiplier((offset + 1.6) + ((2 * i) / $author$project$Entities$Model$playerCount))));
	});
...
var $author$project$Entities$settlementNewRecruitsFromTypePerRound = F2(
	function (s, t) {
		switch (t.$) {
			case 'Sword':
				var _v1 = s.settlementType;
				if (_v1.$ === 'Village') {
					return 1;
				} else {
					return 2;
...
var $author$project$Building$Quarters = {$: 'Quarters'};
...
var $author$project$Building$resolveBonusFromBuildingInfo = F2(
	function (t, l) {
		return $author$project$Building$buildingToBonus(t) * l;
	});
var $author$project$Entities$settlementTroopsRecruitLimit = F3(
	function (s, quartersLevel, troopType) {
		var limit = function () {
			if (_Utils_eq(s.settlementType, $author$project$Entities$Model$Castle)) {
				switch (troopType.$) {
					case 'Sword':
						return 10;
					case 'Spear':
		...
		return limit + $elm$core$Basics$round(
			A2($author$project$Building$resolveBonusFromBuildingInfo, $author$project$Building$Quarters, quartersLevel));
	});
var $author$project$Entities$applySettlementNewRecruits = F2(
	function (quarterLevel, s) {
					...
					F2(
						function (t, amount) {
							return A2(
								$elm$core$Basics$min,
								A3(
									$author$project$Entities$settlementTroopsRecruitLimit,
									s,
									quarterLevel,
									$author$project$Troops$intToTroopType(t)),
								amount + A2(
									$author$project$Entities$settlementNewRecruitsFromTypePerRound,
									s,
									$author$project$Troops$intToTroopType(t)));
						}),
					s.recruitLimits)
...
var $author$project$Troops$capitalStartTroops = A3(
	$elm$core$List$foldl,
	F2(
		function (_v0, dict) {
			var t = _v0.a;
	...
	_List_fromArray(
		[
			_Utils_Tuple2($author$project$Troops$Archer, 30),
			_Utils_Tuple2($author$project$Troops$Spear, 5),
			_Utils_Tuple2($author$project$Troops$Sword, 15),
			_Utils_Tuple2($author$project$Troops$Knight, 5)
		]));
var $author$project$Troops$troopTypeList = _List_fromArray(
	[$author$project$Troops$Knight, $author$project$Troops$Archer, $author$project$Troops$Spear, $author$project$Troops$Sword]);
...
var $author$project$Building$startBuildings = _List_fromArray(
	[
		{buildingType: $author$project$Building$Quarters, level: 0, name: 'Quarters'},
...
var $author$project$Entities$createCapitalFor = F2(
	function (e, name) {
		return A2(
			$author$project$Entities$applySettlementNewRecruits,
			0,
			{
				buildings: $author$project$Building$startBuildings,
				entity: {army: $author$project$Troops$capitalStartTroops, faction: e.faction, name: name, position: e.position},
				isSieged: false,
...
var $author$project$Troops$villageStartTroops = A3(
	$elm$core$List$foldl,
	F2(
		function (_v0, dict) {
			var t = _v0.a;
	...
	_List_fromArray(
		[
			_Utils_Tuple2($author$project$Troops$Archer, 15),
			_Utils_Tuple2($author$project$Troops$Spear, 0),
			_Utils_Tuple2($author$project$Troops$Sword, 15),
			_Utils_Tuple2($author$project$Troops$Knight, 0)
		]));
var $author$project$Entities$getSettlementFor = function (info) {
	return A2(
		...
		{
			buildings: $author$project$Building$startBuildings,
			entity: {army: $author$project$Troops$villageStartTroops, faction: info.faction, name: info.name, position: info.position},
			isSieged: false,
			recruitLimits: $author$project$Troops$emptyTroops,
...
var $author$project$Entities$Model$villageCaptialDistance = 6;
var $author$project$Main$getVillagesPosition = F4(
	function (max, q, i, p) {
		var rad = (0.5 * $elm$core$Basics$pi) * ((i / max) + ((-q) + 1.9));
		var distanceFromCapital = $author$project$Entities$Model$villageCaptialDistance + $elm$core$Basics$round(
			4 * $elm$core$Basics$sin(($elm$core$Basics$pi * (i - 1)) / (max - 1)));
...
var $author$project$Main$getVillagesInQuadrant = F3(
	function (e, q, i) {
		return A2(
			$elm$core$List$map,
			function (index) {
...
var $author$project$Entities$Model$villagesPerLord = 3;
		...
		return A2(
			...
			A2(
				...
				A3(
					...
					m,
					usedFields,
					A3($author$project$Main$getVillagesInQuadrant, e, i, $author$project$Entities$Model$villagesPerLord))));
	});
var $author$project$Troops$lordStartTroops = A3(
	$elm$core$List$foldl,
	F2(
		function (_v0, dict) {
			var t = _v0.a;
	...
	_List_fromArray(
		[
			_Utils_Tuple2($author$project$Troops$Archer, 5),
			_Utils_Tuple2($author$project$Troops$Spear, 15),
			_Utils_Tuple2($author$project$Troops$Sword, 10),
			_Utils_Tuple2($author$project$Troops$Knight, 5)
		]));
var $author$project$Main$initPlayer = F4(
	function (name, m, i, rad) {
		var entity = A4(
			$author$project$Entities$Model$WorldEntity,
			$author$project$Troops$lordStartTroops,
		...
		return A4(
			...
			$author$project$PathAgent$getAgent(6));
	});
var $author$project$Main$initPlayers = F3(
	function (playerName, m, count) {
		return A2(
			$author$project$Entities$Lords$Cons,
			A4(
				$author$project$Main$initPlayer,
			...
			A2(
				...
				function (i) {
					return A3(
						$author$project$Main$initAI,
						A4(
							$author$project$Main$initPlayer,
							A2($author$project$ListExt$getElementAt, i, $author$project$Entities$Model$aiNames),
							m,
							i,
							2 * ((i / count) + 0.125)),
						i,
						$author$project$Main$hashString(playerName) / 97);
				},
				A2($elm$core$List$range, 1, count - 1)));
	});
var $author$project$Main$initialModel = function (playerName) {
	var map = $author$project$MapGenerator$createMap(
		$author$project$Main$hashString(playerName));
	return $author$project$Main$Model(
		A3($author$project$Main$initPlayers, playerName, map, $author$project$Entities$Model$playerCount))(
		$author$project$Main$GameSetup(
			$author$project$Main$MainMenue($author$project$Main$Menue)))($elm$core$Maybe$Nothing)(
		A2($author$project$DateExt$Date, 1017, $author$project$DateExt$Jan))(map)('')(
		{events: _List_Nil, state: true})(0)(playerName)(10);
};
var $author$project$Main$startGame = F2(
	function (playerName, cmd) {
		return _Utils_Tuple2(
			$author$project$Main$initialModel(playerName),
			cmd);
	});
var $author$project$Msg$AiRoundTick = {$: 'AiRoundTick'};
var $author$project$Main$aiTickFrequenz = 10;
...
var $author$project$Main$tickSub = function (model) {
	return ($author$project$Main$isPlayersTurn(model) || $author$project$Main$isGameOver(model)) ? $elm$core$Platform$Sub$none : A2(
		...
		function (_v0) {
			return $author$project$Msg$AiRoundTick;
		});
};
...
var $author$project$Main$hasGameStarted = function (m) {
	var _v0 = m.gameState;
	if (_v0.$ === 'GameSetup') {
		var state = _v0.a;
		if (state.$ === 'MainMenue') {
...
var $author$project$Entities$Lords$getPlayer = function (_v0) {
	var p = _v0.a;
	return p;
};
var $author$project$Main$getPlayer = function (model) {
	return $author$project$Entities$Lords$getPlayer(model.lords);
};
var $author$project$Main$hasPlayerLost = function (m) {
	return !$author$project$MaybeExt$hasValue(
		$author$project$Entities$getLordCapital(
			$author$project$Main$getPlayer(m).land));
};
var $author$project$Entities$Lords$npcs = function (_v0) {
	var ais = _v0.b;
	return A2(
		$elm$core$List$map,
		function ($) {
...
var $author$project$Main$checkIfGameEnded = function (m) {
	return $author$project$Main$hasGameStarted(m) ? ($author$project$Main$hasPlayerLost(m) ? _Utils_update(
		m,
		{
			gameState: $author$project$Main$GameOver(false)
		}) : ((!$elm$core$List$length(
		$author$project$Entities$Lords$npcs(m.lords))) ? _Utils_update(
		m,
		{
			gameState: $author$project$Main$GameOver(true)
		}) : m)) : m;
};
var $author$project$Main$emptyCmd = function (m) {
	return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
};
var $author$project$Entities$Lords$lordListToList = function (_v0) {
	var l = _v0.a;
	var ais = _v0.b;
	return A2(
		$elm$core$List$cons,
...
var $author$project$Main$endAnyRound = function (m) {
	return (_Utils_cmp(
		m.playersTurn + 1,
		$elm$core$List$length(
			$author$project$Entities$Lords$lordListToList(m.lords))) > -1) ? _Utils_update(
		m,
		{playersTurn: 0}) : _Utils_update(
		m,
		{playersTurn: m.playersTurn + 1});
};
...
var $author$project$Entities$settlementIncome = function (t) {
	if (t.$ === 'Castle') {
		return 35;
	} else {
		return 50;
...
var $author$project$Entities$sumSettlementsIncome = function (settlements) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (s, v) {
				return $author$project$Entities$settlementIncome(s.settlementType) + v;
			}),
		0,
		settlements);
};
...
var $author$project$Building$getBuilding = F2(
	function (t, bs) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (b) {
					return _Utils_eq(b.buildingType, t);
				},
				bs));
	});
var $author$project$Entities$applySettlementsNewRecruits = function (l) {
	var _v0 = A2(
		$elm$core$Maybe$andThen,
		function (c) {
			return A2($author$project$Building$getBuilding, $author$project$Building$Quarters, c.buildings);
		},
		$author$project$Entities$getLordCapital(l.land));
	if (_v0.$ === 'Nothing') {
		return l.land;
	} else {
		var quarters = _v0.a;
		return A2(
			$elm$core$List$map,
			$author$project$Entities$applySettlementNewRecruits(quarters.level),
			l.land);
	}
};
var $author$project$Entities$applyLordNewRecruits = function (lord) {
	return _Utils_update(
		lord,
		{
			land: $author$project$Entities$applySettlementsNewRecruits(lord)
		});
};
...
var $author$project$PathAgent$resetLordUsedMovement = function (l) {
	return _Utils_update(
		l,
		{
			agent: $author$project$PathAgent$resetUsedMovement(l.agent)
		});
};
var $author$project$Main$endRoundForLord = function (l) {
	return $author$project$Entities$applyLordNewRecruits(
		$author$project$PathAgent$resetLordUsedMovement(
			$author$project$Entities$applyLordGoldIncome(l)));
};
var $author$project$Event$appendEvent = F2(
	function (es, e) {
		return _Utils_update(
			es,
			{
				events: A2($elm$core$List$cons, e, es.events)
			});
	});
...
var $author$project$PathAgent$enoughMovementToMove = F2(
	function (path, agent) {
		var _v0 = $author$project$Pathfinder$cutFirstStepFromPath(path).path;
		if (!_v0.b) {
			return true;
		} else {
			var p = _v0.a;
			return A3($author$project$PathAgent$canReachInRound, agent.speed, agent.usedMovement, p.timeLoss);
		}
	});
...
var $author$project$MapAction$hasActionOnPoint = F3(
	function (p, msg, dict) {
		return A2(
...
var $author$project$Pathfinder$canMoveToPoint = F2(
	function (dict, p) {
		return A3(
			$author$project$MapAction$hasActionOnPoint,
			p,
...
var $author$project$Pathfinder$getPathTo = F3(
	function (from, to, map) {
		return A2(
			$author$project$Pathfinder$canMoveToPoint,
			$author$project$Map$Drawer$drawMap(map),
			to) ? A2(
...
var $author$project$PathAgent$canMoveTowardsInTurn = F3(
	function (m, l, p) {
		var _v0 = A3($author$project$Pathfinder$getPathTo, l.entity.position, p, m);
		if (_v0.$ === 'Nothing') {
			return true;
		} else {
			var path = _v0.a;
			return A2($author$project$PathAgent$enoughMovementToMove, path, l.agent);
		}
	});
var $author$project$OperatorExt$flip = F3(
	function (f, b, a) {
		return A2(f, a, b);
	});
var $author$project$AI$Model$EndRound = {$: 'EndRound'};
var $author$project$AI$AIActionDistanceHandler$distanceFromMoveToPenalty = function (turns) {
	return turns * 0.075;
};
var $author$project$AI$AIActionDistanceHandler$distanceFromAttackLordPenalty = function (turns) {
	return turns * 2.5;
};
var $author$project$AI$AIActionDistanceHandler$distanceFromCapitalSiegeActionPenalty = function (turns) {
	return turns * 0.085;
};
var $author$project$AI$AIActionDistanceHandler$distanceFromVillageSiegeActionPenalty = function (turns) {
	return turns * 0.095;
};
var $author$project$AI$AIActionDistanceHandler$distanceHireTroopsActionPenalty = function (turns) {
	return turns * 0.045;
};
var $author$project$AI$AIActionDistanceHandler$distanceImproveBuildingActionPenalty = function (turns) {
	return turns * 0.09;
};
var $author$project$AI$AIActionDistanceHandler$distanceSwapTroopsActionPenalty = function (turns) {
	return turns * 0.05;
};
var $author$project$AI$AIActionDistanceHandler$getBaseActionDistancePenalty = F3(
	function (ai, basicAction, i) {
		switch (basicAction.$) {
			case 'AttackLord':
				var l = basicAction.a;
				return A2(
					$elm$core$Basics$max,
					0,
					$author$project$AI$AIActionDistanceHandler$distanceFromAttackLordPenalty(i) * (2 - ai.strategy.battleMultiplier));
			case 'HireTroops':
				return (i < 0) ? (-2) : ($author$project$AI$AIActionDistanceHandler$distanceHireTroopsActionPenalty(i) * (2 - ai.strategy.defendMultiplier));
			case 'SwapTroops':
				var s = basicAction.b;
				return (i < 0) ? (_Utils_eq(s.settlementType, $author$project$Entities$Model$Castle) ? A2($elm$core$Basics$min, 0, 1 - (ai.strategy.defendMultiplier * 3)) : A2($elm$core$Basics$min, 0, 1 - ((ai.strategy.defendMultiplier + 0.1) * 1.5))) : ($author$project$AI$AIActionDistanceHandler$distanceSwapTroopsActionPenalty(i) * (2 - ai.strategy.defendMultiplier));
			case 'SiegeSettlement':
				var s = basicAction.a;
				return _Utils_eq(s.settlementType, $author$project$Entities$Model$Castle) ? ($author$project$AI$AIActionDistanceHandler$distanceFromCapitalSiegeActionPenalty(i) * (2 - ai.strategy.siegeMultiplier)) : ($author$project$AI$AIActionDistanceHandler$distanceFromVillageSiegeActionPenalty(i) * (2 - ai.strategy.siegeMultiplier));
			default:
				return $author$project$AI$AIActionDistanceHandler$distanceImproveBuildingActionPenalty(
					A2($elm$core$Basics$max, 0, i));
		}
	});
var $author$project$AI$AIActionDistanceHandler$getActionDistancePenalty = F3(
	function (ai, a, turnsToPoint) {
		switch (a.$) {
			case 'EndRound':
				return 0;
			case 'GoSomeWhere':
				return $author$project$AI$AIActionDistanceHandler$distanceFromMoveToPenalty(turnsToPoint);
			default:
				var baseAction = a.a;
				return A3($author$project$AI$AIActionDistanceHandler$getBaseActionDistancePenalty, ai, baseAction, turnsToPoint);
		}
	});
var $author$project$AI$AIActionDistanceHandler$getBasicActionDestination = function (basicAction) {
	switch (basicAction.$) {
		case 'AttackLord':
			var l = basicAction.a;
...
var $author$project$AI$AIActionDistanceHandler$getAiRoundActionDestination = function (a) {
	switch (a.$) {
		case 'EndRound':
			return $elm$core$Maybe$Nothing;
		case 'GoSomeWhere':
		...
		default:
			var basicAction = a.a;
			return $elm$core$Maybe$Just(
				$author$project$AI$AIActionDistanceHandler$getBasicActionDestination(basicAction));
	}
};
var $author$project$AI$AIActionDistanceHandler$applyActionDistancePenalty = F3(
	function (ai, turnsToPoint, action) {
		var destination = $author$project$AI$AIActionDistanceHandler$getAiRoundActionDestination(action.action);
		var turnsToAction = A3(
			$author$project$MaybeExt$foldMaybe,
			function (p) {
				return turnsToPoint(p);
			},
			0,
			destination);
		return _Utils_update(
			action,
			{
				actionValue: action.actionValue - A3($author$project$AI$AIActionDistanceHandler$getActionDistancePenalty, ai, action.action, turnsToAction)
			});
	});
var $author$project$AI$Model$AiRoundActionPreference = F2(
	function (action, actionValue) {
		return {action: action, actionValue: actionValue};
	});
var $author$project$AI$Model$AttackLord = function (a) {
	return {$: 'AttackLord', a: a};
};
var $author$project$AI$Model$DoSomething = function (a) {
...
var $author$project$Troops$sumTroopStats = F2(
	function (t, amount) {
		return $elm$core$Basics$round(
			$author$project$Troops$troopDamage(t) + $author$project$Troops$troopDefense(t)) * amount;
	});
var $author$project$Troops$sumArmyStats = A2(
	$elm$core$Dict$foldl,
	F3(
		function (k, v, r) {
			return A2(
				$author$project$Troops$sumTroopStats,
		...
		F2(
			function (l, actions) {
				...
				var preference = A2(
					...
					(strengthFactor + A2($elm$core$Basics$min, 1, l.gold / 2000)) * ai.strategy.battleMultiplier);
				return ((strengthFactor >= 1) && (!$author$project$Entities$isLordInOwnSettlement(l))) ? A2(
					$elm$core$List$cons,
					A2(
						$author$project$AI$Model$AiRoundActionPreference,
						$author$project$AI$Model$DoSomething(
							$author$project$AI$Model$AttackLord(l)),
						preference),
					actions) : actions;
			}),
		_List_Nil);
};
var $author$project$AI$Model$ImproveBuilding = F2(
	function (a, b) {
		return {$: 'ImproveBuilding', a: a, b: b};
	});
var $author$project$AI$AIGoldManager$getBuildingBuildFactor = F2(
	function (ai, t) {
		switch (t.$) {
			case 'Quarters':
				return 1 * ai.strategy.growArmyMultiplier;
			case 'Barracks':
				return 1 * A2($elm$core$Basics$max, ai.strategy.battleMultiplier, ai.strategy.siegeMultiplier);
			default:
				return 1 * ai.strategy.defendMultiplier;
		}
	});
var $author$project$AI$AIGoldManager$goldIncomePerRound = function (ai) {
	return $author$project$Entities$calculateRoundIncome(ai.lord);
};
...
var $author$project$Building$upgradeBuildingInfoCost = F2(
	function (t, l) {
		return $author$project$Building$upgradeCostBase(t) + (($author$project$Building$upgradeCostBase(t) / 2) * l);
	});
var $author$project$Building$upgradeBuildingCost = function (b) {
	return A2($author$project$Building$upgradeBuildingInfoCost, b.buildingType, b.level + 1);
};
var $author$project$AI$AIGoldManager$getBuildingBuildFactors = F3(
	function (ai, capital, b) {
		return ((b.level < 3) && (_Utils_cmp(
			ai.lord.gold,
			$author$project$Building$upgradeBuildingCost(b)) > 0)) ? $elm$core$Maybe$Just(
			A2(
				$author$project$AI$Model$AiRoundActionPreference,
				$author$project$AI$Model$DoSomething(
					A2($author$project$AI$Model$ImproveBuilding, capital, b)),
				A2(
					$elm$core$Basics$min,
					2 + ai.strategy.improveSettlementsMultiplier,
					A2($author$project$AI$AIGoldManager$getBuildingBuildFactor, ai, b.buildingType) * ((($author$project$AI$AIGoldManager$goldIncomePerRound(ai) * 1.75) / $author$project$Building$upgradeBuildingCost(b)) + (A2(
						$elm$core$Basics$logBase,
						10,
						ai.lord.gold / $author$project$Building$upgradeBuildingCost(b)) / 1.5))))) : $elm$core$Maybe$Nothing;
	});
var $author$project$ListExt$justList = A2(
	$elm$core$List$foldr,
	F2(
		function (m, r) {
			return A3(
	...
	_List_Nil);
var $author$project$AI$getImproveBuildingActions = function (ai) {
	var _v0 = $author$project$Entities$getLordCapital(ai.lord.land);
	if (_v0.$ === 'Nothing') {
		return _List_Nil;
	} else {
		var capital = _v0.a;
		return $author$project$ListExt$justList(
			A2(
				$elm$core$List$map,
				A2($author$project$AI$AIGoldManager$getBuildingBuildFactors, ai, capital),
				capital.buildings));
	}
};
...
var $author$project$Building$resolveBonusFromBuildings = F2(
	function (bs, t) {
		var _v0 = A2($author$project$Building$getBuilding, t, bs);
		if (_v0.$ === 'Nothing') {
			return 0;
		} else {
			var b = _v0.a;
			return $author$project$Building$resolveBonusFromBuilding(b);
		}
	});
var $author$project$Entities$getSettlementBonus = F2(
	function (s, l) {
		return _Utils_eq(s.settlementType, $author$project$Entities$Model$Village) ? 1.2 : (A3(
			$elm$core$List$foldr,
			F2(
				function (_v0, y) {
					return 0.15 + y;
			...
			1,
			l) + (A2($author$project$Building$resolveBonusFromBuildings, s.buildings, $author$project$Building$Fortress) / 100));
	});
var $author$project$Entities$isLandlord = F2(
	function (s, l) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (s2, b) {
					return b || _Utils_eq(s2.entity.name, s.entity.name);
				}),
			false,
			l.land);
	});
...
var $author$project$Entities$landlordOnSettlement = function (s) {
	return A2(
		$elm$core$List$foldl,
		F2(
			function (l, r) {
				return (A2($author$project$Entities$isLandlord, s, l) && A2($author$project$Entities$isLordOnSettlement, l, s)) ? $elm$core$Maybe$Just(l) : r;
			}),
		$elm$core$Maybe$Nothing);
};
var $author$project$AI$AISettlementHandling$settlementDefenseStrength = F2(
	function (s, extraDefender) {
		if (extraDefender.$ === 'Nothing') {
			return $author$project$Troops$sumArmyStats(s.entity.army);
		} else {
			var l = extraDefender.a;
...
var $author$project$AI$AIOffsensiveActionHandler$evaluateSettlementSiegeAction = F3(
	function (ai, s, ls) {
		var siegeStrengthDiff = $author$project$Troops$sumArmyStats(ai.lord.entity.army) / A2(
			...
			A2(
				$author$project$AI$AISettlementHandling$settlementDefenseStrength,
				s,
				A2($author$project$Entities$landlordOnSettlement, s, ls)) * A3(
				$author$project$MaybeExt$foldMaybe,
				function (l) {
		...
		return (siegeStrengthDiff >= 1) ? $elm$core$Maybe$Just(
			A2(
				$author$project$AI$Model$AiRoundActionPreference,
				$author$project$AI$Model$DoSomething(
					$author$project$AI$Model$SiegeSettlement(s)),
				A2(
					$elm$core$Basics$min,
...
var $author$project$AI$Model$SwapTroops = F2(
	function (a, b) {
...
var $author$project$AI$AITroopHandling$estimatedSettlementDefenseStrength = F2(
	function (ai, t) {
		if (t.$ === 'Village') {
			return $author$project$AI$AITroopHandling$estimatedNormalVillageTroopStrength(ai);
		} else {
...
var $author$project$Troops$troopStrengthDeffSum = function (t) {
	return $elm$core$Basics$round(
		$author$project$Troops$troopDamage(t) + $author$project$Troops$troopDefense(t));
};
var $author$project$AI$AITroopHandling$takeTroopsToLeaveArmyAtStrength = F2(
	function (strength, army) {
		return A3(
			$elm$core$Dict$foldl,
			F3(
				function (k, v, _v0) {
					var currentStrength = _v0.a;
					var dict = _v0.b;
					var troopStats = $author$project$Troops$troopStrengthDeffSum(
						$author$project$Troops$intToTroopType(k));
					var notAvailableAmount = A3($elm$core$Basics$clamp, 0, v, ((strength - currentStrength) / troopStats) | 0);
					return _Utils_Tuple2(
						currentStrength + (troopStats * notAvailableAmount),
						A3($elm$core$Dict$insert, k, v - notAvailableAmount, dict));
				}),
			_Utils_Tuple2(0, $elm$core$Dict$empty),
			army).b;
	});
var $author$project$AI$AITroopHandling$troopStrengthToBotherAddingToSettlement = 0;
var $author$project$AI$AITroopHandling$hasTroopsToSatisfySettlementDefense = function (ai) {
	return _Utils_cmp(
		$author$project$Troops$sumArmyStats(
			A2(
				$author$project$AI$AITroopHandling$takeTroopsToLeaveArmyAtStrength,
				$author$project$AI$AITroopHandling$estimatedNormalPlayerTroopStrength(ai),
				ai.lord.entity.army)),
		$author$project$AI$AITroopHandling$troopStrengthToBotherAddingToSettlement) > -1;
};
var $author$project$AI$AITroopHandling$settlementLackOfTroopStrength = F2(
	function (ai, s) {
		return $elm$core$Basics$round(
			A2($author$project$AI$AITroopHandling$estimatedSettlementDefenseStrength, ai, s.settlementType)) - $author$project$Troops$sumArmyStats(s.entity.army);
	});
var $author$project$AI$AITroopHandling$settlementStationTroopsFactor = F2(
	function (ai, s) {
		var _v0 = s.settlementType;
		if (_v0.$ === 'Castle') {
			return 1;
		} else {
			return A3($elm$core$Basics$clamp, 0.5, 1, 0.75 * ai.strategy.defendMultiplier);
		}
	});
var $author$project$AI$AITroopHandling$takeDisposableTroopsWithMaxStrength = F3(
	function (sourceArmy, sourceNeededStrength, maxStrength) {
		return A2(
			$author$project$AI$AITroopHandling$takeTroopsToLeaveArmyAtStrength,
			A2(
				$elm$core$Basics$max,
				sourceNeededStrength,
				$author$project$Troops$sumArmyStats(sourceArmy) - maxStrength),
			sourceArmy);
	});
var $author$project$AI$AITroopHandling$evaluateSettlementDefense = F2(
	function (ai, s) {
		if ((A2($author$project$AI$AITroopHandling$settlementLackOfTroopStrength, ai, s) - $author$project$AI$AITroopHandling$acceptedLackOfDefenseStrength) < 0) {
			return $elm$core$Maybe$Nothing;
		} else {
			if ($author$project$AI$AITroopHandling$hasTroopsToSatisfySettlementDefense(ai)) {
				var swapTroops = A3(
					$author$project$AI$AITroopHandling$takeDisposableTroopsWithMaxStrength,
					ai.lord.entity.army,
					$author$project$AI$AITroopHandling$estimatedNormalPlayerTroopStrength(ai),
					$elm$core$Basics$round(
						A2($author$project$AI$AITroopHandling$settlementLackOfTroopStrength, ai, s) * A2($author$project$AI$AITroopHandling$settlementStationTroopsFactor, ai, s)));
				return ($author$project$Troops$sumArmyStats(swapTroops) > 0) ? $elm$core$Maybe$Just(
					A2(
						$author$project$AI$Model$AiRoundActionPreference,
						$author$project$AI$Model$DoSomething(
							A2($author$project$AI$Model$SwapTroops, swapTroops, s)),
						A2(
							$elm$core$Basics$min,
...
var $author$project$AI$getSettlementDefenseActions = F2(
	function (ai, enemies) {
		return $author$project$ListExt$justList(
			A3(
				$elm$core$List$foldl,
				F2(
					function (s, r) {
						return A2(
							$elm$core$List$cons,
							A2($author$project$AI$AITroopHandling$evaluateSettlementDefense, ai, s),
							r);
					}),
				_List_Nil,
				ai.lord.land));
	});
var $author$project$AI$Model$HireTroops = F2(
	function (a, b) {
		return {$: 'HireTroops', a: a, b: b};
	});
var $author$project$AI$AITroopHandling$acceptedMissingTroopsStrength = function (ai) {
	return $elm$core$Basics$round(
		((A2($author$project$AI$AITroopHandling$estimatedSettlementDefenseStrength, ai, $author$project$Entities$Model$Castle) + $author$project$AI$AITroopHandling$estimatedNormalPlayerTroopStrength(ai)) + A2($author$project$AI$AITroopHandling$estimatedSettlementDefenseStrength, ai, $author$project$Entities$Model$Village)) / 2);
};
var $author$project$Troops$getTroopTypeInArmyStats = F2(
	function (a, t) {
		return A3(
			$author$project$MaybeExt$foldMaybe,
			$author$project$Troops$sumTroopStats(t),
			0,
			A2(
				$elm$core$Dict$get,
				$author$project$Troops$troopTypeToInt(t),
...
var $author$project$AI$AISettlementHandling$settlementRecruitUsage = F3(
	function (l, s, a) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			function (c) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var _v1 = A3(
				...
				F2(
					function (t, _v2) {
						var maxStrength = _v2.a;
						var currentStrength = _v2.b;
						return _Utils_Tuple2(
							maxStrength + A2(
								$author$project$Troops$sumTroopStats,
								t,
								A3($author$project$Entities$settlementTroopsRecruitLimit, s, quarters.level, t)),
							currentStrength + A2($author$project$Troops$getTroopTypeInArmyStats, a, t));
					}),
				_Utils_Tuple2(0, 0),
				$author$project$Troops$troopTypeList);
			var maxRecruitStrength = _v1.a;
			var currentRecruitStrength = _v1.b;
			return currentRecruitStrength / maxRecruitStrength;
		}
	});
...
var $author$project$Troops$updateTroopsFrom = F2(
	function (army, i) {
		return A2(
			$author$project$Troops$updateTroops,
			army,
			$author$project$Troops$intToTroopType(i));
	});
var $author$project$Troops$substractArmy = F2(
	function (a1, a2) {
		return A3(
			$elm$core$Dict$foldl,
			F3(
				function (k, v, army) {
					return A3($author$project$Troops$updateTroopsFrom, army, k, -v);
				}),
			a1,
			a2);
	});
...
var $author$project$Troops$averageTroopStrengthCostRatio = A3(
	$elm$core$List$foldl,
	F2(
		function (t, _v0) {
			var r = _v0.a;
			var c = _v0.b;
			return _Utils_Tuple2(
				r + ((($author$project$Troops$troopStrengthDeffSum(t) / $author$project$Troops$troopCost(t)) - r) / c),
				c + 1);
		}),
	_Utils_Tuple2(0, 1),
	$author$project$Troops$troopTypeList).a;
var $author$project$AI$AIGoldManager$takeAsMuchAsPossible = F3(
	function (cost, gold, maxValue) {
		return A2(
			$elm$core$Basics$min,
			maxValue,
			$elm$core$Basics$floor(gold / cost));
	});
var $author$project$AI$AITroopHandling$troopAmountWithStrength = F2(
	function (strength, neededStrength) {
		return A2(
			$elm$core$Basics$max,
			0,
			$elm$core$Basics$round(neededStrength / strength));
	});
var $author$project$AI$AITroopHandling$tryBuyTroopsWithTotalStrenghtFrom = F3(
	function (aI, targetStrength, settlement) {
		return A3(
			$elm$core$Dict$foldl,
			F3(
				function (k, v, _v0) {
					var gold = _v0.a;
					var dict = _v0.b;
					var troopCost = $author$project$Troops$troopCost(
						$author$project$Troops$intToTroopType(k));
					var amount = A3(
						$author$project$AI$AIGoldManager$takeAsMuchAsPossible,
						troopCost,
						gold,
						A2(
							$elm$core$Basics$min,
							v,
							A2(
								$author$project$AI$AITroopHandling$troopAmountWithStrength,
								$author$project$Troops$troopStrengthDeffSum(
									$author$project$Troops$intToTroopType(k)),
								targetStrength - $elm$core$Basics$round($author$project$Troops$averageTroopStrengthCostRatio))));
					return _Utils_Tuple2(
						gold - (amount * troopCost),
						A3($elm$core$Dict$insert, k, amount, dict));
				}),
			_Utils_Tuple2(aI.lord.gold, $elm$core$Dict$empty),
			settlement.recruitLimits).b;
	});
var $author$project$AI$AITroopHandling$checkSettlementForRecruits = F3(
	function (targetStrength, ai, s) {
		var recruitableTroopsDict = A3($author$project$AI$AITroopHandling$tryBuyTroopsWithTotalStrenghtFrom, ai, targetStrength, s);
		var recruitStrengthFactor = A2(
			$elm$core$Basics$min,
			1,
		...
		var recruitNeedFactor = A2(
			...
			targetStrength / $author$project$AI$AITroopHandling$acceptedMissingTroopsStrength(ai));
		var actionValue = A2(
			$elm$core$Basics$min,
			2 + ai.strategy.defendMultiplier,
		...
		return (recruitStrengthFactor > 0) ? $elm$core$Maybe$Just(
			A2(
				$author$project$AI$Model$AiRoundActionPreference,
				$author$project$AI$Model$DoSomething(
					A2($author$project$AI$Model$HireTroops, recruitableTroopsDict, s)),
				actionValue)) : $elm$core$Maybe$Nothing;
	});
var $author$project$AI$AITroopHandling$checkSettlementsForRecruits = F2(
	function (targetStrength, ai) {
		return $author$project$ListExt$justList(
			A2(
				$elm$core$List$map,
...
var $author$project$AI$AITroopHandling$maximalAcceptedSettlementStrength = F2(
	function (ai, s) {
		return $elm$core$Basics$round(
			A2($author$project$AI$AITroopHandling$estimatedSettlementDefenseStrength, ai, s.settlementType) * 1.75);
	});
var $author$project$AI$AITroopHandling$totalNeededTroopStrength = F2(
	function (ai, op) {
		return A2(
			$elm$core$Basics$max,
			0,
			A3(
				$elm$core$List$foldl,
				F2(
					function (s, neededStrength) {
						return neededStrength + op(
							$elm$core$Basics$round(
								A2($author$project$AI$AITroopHandling$maximalAcceptedSettlementStrength, ai, s)) - $author$project$Troops$sumArmyStats(ai.lord.entity.army));
					}),
				A2(
					$elm$core$Basics$max,
					0,
					$author$project$AI$AITroopHandling$maximalAcceptedPlayerStrength(ai) - $author$project$Troops$sumArmyStats(ai.lord.entity.army)),
				ai.lord.land));
	});
...
var $author$project$AI$AITroopHandling$settlementDisposableTroops = F2(
	function (ai, s) {
		return A2(
			$author$project$AI$AITroopHandling$takeTroopsToLeaveArmyAtStrength,
			A2($author$project$AI$AITroopHandling$maximalAcceptedSettlementStrength, ai, s),
			s.entity.army);
	});
var $author$project$AI$AITroopHandling$checkSettlementForAvaiableTroops = F3(
	function (targetStrength, ai, s) {
		var availableTroops = A2($author$project$AI$AITroopHandling$settlementDisposableTroops, ai, s);
		var troopStrength = $author$project$Troops$sumArmyStats(availableTroops);
		return (troopStrength > 0) ? $elm$core$Maybe$Just(
			A2(
				$author$project$AI$Model$AiRoundActionPreference,
				$author$project$AI$Model$DoSomething(
					A2(
						$author$project$AI$Model$SwapTroops,
						$author$project$Troops$invertArmy(availableTroops),
						s)),
				A2(
					$elm$core$Basics$min,
					2 + ai.strategy.defendMultiplier,
					(targetStrength / ($author$project$AI$AITroopHandling$acceptedMissingTroopsStrength(ai) / 3)) * A2($elm$core$Basics$min, 1, troopStrength / targetStrength)))) : $elm$core$Maybe$Nothing;
	});
var $author$project$AI$AITroopHandling$takeTroopsFromSettlements = function (ai) {
	var neededStrength = A2($author$project$AI$AITroopHandling$totalNeededTroopStrength, ai, $elm$core$Basics$identity);
	return $author$project$ListExt$justList(
		A2(
			$elm$core$List$map,
			A2($author$project$AI$AITroopHandling$checkSettlementForAvaiableTroops, neededStrength, ai),
			ai.lord.land));
};
var $author$project$AI$getAiActions = F2(
	function (ai, enemies) {
		var takeTroops = $author$project$AI$AITroopHandling$takeTroopsFromSettlements(ai);
			...
			_Utils_ap(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							takeTroops,
							_Utils_ap(attackOthers, improveBuildingFactor))))));
	});
var $author$project$AI$getAiActionsWithDistancePenalty = F3(
	function (ai, distanceTo, enemies) {
		return A2(
			$elm$core$List$map,
			A2(
				$author$project$AI$AIActionDistanceHandler$applyActionDistancePenalty,
				ai,
				distanceTo(ai.lord)),
			A2($author$project$AI$getAiActions, ai, enemies));
	});
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$AI$getAiAction = F4(
	function (ai, distanceTo, canMoveInTurn, enemies) {
		var _v0 = $elm$core$List$head(
			A2(
				...
				A3($author$project$AI$getAiActionsWithDistancePenalty, ai, distanceTo, enemies)));
		if (_v0.$ === 'Nothing') {
			return $author$project$AI$Model$EndRound;
		} else {
			var action = _v0.a;
			var _v1 = $author$project$AI$AIActionDistanceHandler$getAiRoundActionDestination(action.action);
			if (_v1.$ === 'Nothing') {
				return $author$project$AI$Model$EndRound;
			} else {
				var p = _v1.a;
				return A2(canMoveInTurn, ai.lord, p) ? action.action : $author$project$AI$Model$EndRound;
			}
		}
	});
var $author$project$Entities$Lords$getAis = function (_v0) {
	var ais = _v0.b;
	return ais;
};
var $author$project$Entities$Lords$getLordsExcept = F2(
	function (ls, lord) {
		return A3(
			$elm$core$List$foldr,
			F2(
				function (l, r) {
					return _Utils_eq(l.entity.name, lord.entity.name) ? r : A2($elm$core$List$cons, l, r);
				}),
			_List_Nil,
			$author$project$Entities$Lords$lordListToList(ls));
	});
...
var $author$project$PathAgent$roundsToFinishPath = F2(
	function (a, ps) {
		var _v0 = $elm$core$List$head(
			A2($author$project$PathAgent$pathPartsToTime, a, ps));
		if (_v0.$ === 'Nothing') {
			return 0;
		} else {
			var t = _v0.a;
...
var $author$project$PathAgent$lordsTurnToReachDestination = F3(
	function (m, l, p) {
		if (_Utils_eq(l.entity.position, p)) {
			return -1;
		} else {
			var _v0 = A3($author$project$Pathfinder$getPathTo, l.entity.position, p, m);
			if (_v0.$ === 'Nothing') {
				...
				var path = _v0.a;
				return A2($author$project$PathAgent$roundsToFinishPath, l.agent, path.path) - 1;
			}
		}
	});
...
var $author$project$PathAgent$moveLordOnPath = F3(
	function (map, l, target) {
		var _v0 = A3($author$project$Pathfinder$getPathTo, l.entity.position, target, map);
		if (_v0.$ === 'Nothing') {
			return l;
		} else {
			var path = _v0.a;
			var _v1 = A3($author$project$PathAgent$moveAlongPath, path, l.entity.position, l.agent);
			var usedMove = _v1.a;
			var point = _v1.b;
			return _Utils_update(
				l,
				{
					agent: A2($author$project$PathAgent$setUsedMovement, usedMove, l.agent),
					entity: A2($author$project$Entities$setPosition, l.entity, point)
				});
		}
	});
var $author$project$Entities$Lords$replaceAi = F2(
	function (lordList, newAi) {
		return A2(
			$author$project$Entities$Lords$Cons,
			$author$project$Entities$Lords$getPlayer(lordList),
			A2(
				$elm$core$List$map,
				function (ai) {
					return _Utils_eq(ai.lord.entity.name, newAi.lord.entity.name) ? newAi : ai;
				},
				$author$project$Entities$Lords$getAis(lordList)));
	});
var $author$project$AI$setLord = F2(
	function (ai, l) {
		return _Utils_update(
			ai,
			{lord: l});
...
var $author$project$Battle$lordBattleAftermath = F2(
	function (l, settlement) {
		if ((!$author$project$Troops$sumTroops(l.entity.army)) && A3(
			$author$project$MaybeExt$foldMaybe,
			function (s) {
				return !(A2($author$project$Entities$isLandlord, s, l) && (A2($author$project$Entities$isLordOnSettlement, l, s) || ($author$project$Troops$sumTroops(s.entity.army) > 0)));
			},
			true,
			settlement)) {
			var _v0 = $author$project$Entities$getLordCapital(l.land);
			if (_v0.$ === 'Nothing') {
				return l;
			} else {
				var settle = _v0.a;
				return _Utils_update(
					l,
					{
						entity: A2($author$project$Entities$setPosition, l.entity, settle.entity.position)
					});
			}
		} else {
			return l;
...
var $author$project$Battle$siegeCastleGoldBonus = 2500.0;
var $author$project$Battle$siegeVillageGoldBonus = 300;
var $author$project$Battle$getGoldBonus = F2(
	function (t, lord) {
		if (t.$ === 'Castle') {
			return _Utils_update(
				lord,
				{gold: lord.gold + $author$project$Battle$siegeCastleGoldBonus});
		} else {
			return _Utils_update(
				lord,
...
var $author$project$Battle$updateSettlementBattleField = F2(
	function (s, l) {
		if (!l.b) {
			return _List_Nil;
		} else {
			var x = l.a;
			var xs = l.b;
			return _Utils_eq(x.entity.name, s.entity.name) ? A2(
				$elm$core$List$cons,
				s,
				A2($author$project$Battle$updateSettlementBattleField, s, xs)) : A2(
				$elm$core$List$cons,
				x,
				A2($author$project$Battle$updateSettlementBattleField, s, xs));
		}
	});
	...
	function (bS, s) {
		...
		return ($author$project$Troops$sumTroops(s.entity.army) <= 0) ? (_Utils_eq(s.settlementType, $author$project$Entities$Model$Castle) ? A5(
			...
			_Utils_update(
				defender,
				{
					land: A2($author$project$Battle$updateSettlementBattleField, s, defender.land)
				}));
	});
var $author$project$Entities$Lords$updateLord = F2(
	function (l, _v0) {
		var player = _v0.a;
		var ais = _v0.b;
		return _Utils_eq(player.entity.name, l.entity.name) ? A2($author$project$Entities$Lords$Cons, l, ais) : A2(
			$author$project$Entities$Lords$Cons,
			player,
			A2(
				$elm$core$List$map,
				function (ai) {
					return _Utils_eq(ai.lord.entity.name, l.entity.name) ? _Utils_update(
						ai,
						{lord: l}) : ai;
				},
				ais));
...
var $author$project$Battle$transferLordFunds = F2(
	function (fl, sl) {
		return A3(
			...
			!$author$project$Troops$sumTroops(sl.entity.army),
			sl.gold / 2,
			0) - A3(
			$author$project$OperatorExt$ternary,
			!$author$project$Troops$sumTroops(fl.entity.army),
			fl.gold / 2,
			0);
	});
var $author$project$Battle$updatedBattleLordFunds = F2(
	function (fl, sl) {
		var slDiff = A2($author$project$Battle$transferLordFunds, sl, fl);
		var flDiff = A2($author$project$Battle$transferLordFunds, fl, sl);
		return _Utils_Tuple2(
			_Utils_update(
				fl,
				{gold: fl.gold + flDiff}),
...
var $author$project$Battle$applyBattleAftermath = F2(
	function (ls, bs) {
		...
		if (_v1.$ === 'Nothing') {
			return A2(
				$author$project$Entities$Lords$updateLord,
				A2($author$project$Battle$lordBattleAftermath, tDL, $elm$core$Maybe$Nothing),
				A2(
					$author$project$Entities$Lords$updateLord,
					A2($author$project$Battle$lordBattleAftermath, tAL, $elm$core$Maybe$Nothing),
					ls));
		} else {
			var s = _v1.a;
			var _v2 = A2($author$project$Battle$siegeBattleAftermath, bs, s);
			var newAttacker = _v2.a;
			var newDefender = _v2.b;
			return A2(
				$author$project$Entities$Lords$updateLord,
				newDefender,
				A2($author$project$Entities$Lords$updateLord, newAttacker, ls));
		}
	});
...
var $author$project$Battle$calculateEntityCasualties = F2(
	function (armyBefore, armyAfter) {
		return A6(
			...
			F3(
				function (k, v, r) {
					return A3($elm$core$Dict$insert, k, -v, r);
				}),
			F4(
				function (k, v1, v2, r) {
...
var $author$project$Battle$constructBattleResult = F6(
	function (bS, attacker, defender, settle, aCasu, dCasu) {
		return _Utils_update(
			bS,
			{
				attacker: A2($author$project$Battle$lordBattleAftermath, attacker, bS.settlement),
				attackerCasualties: aCasu,
				defender: A2($author$project$Battle$lordBattleAftermath, defender, bS.settlement),
...
var $author$project$Battle$calcCasualties = F4(
	function (t, amount, d, dF) {
		return A2(
			$elm$core$Basics$max,
			0,
			amount - $elm$core$Basics$round(
				d / ($author$project$Troops$troopDefense(t) * dF)));
	});
var $author$project$Battle$calcTroopCasualties = F4(
	function (army, d, dF, a) {
		return A2(
			$elm$core$Dict$map,
			F2(
				function (k, v) {
...
var $author$project$Battle$evaluateLordCasualities = F3(
	function (w, d, dF) {
		return _Utils_update(
			w,
			{
...
var $author$project$Battle$evaluateBattle = F5(
	function (w, army, ter, dF, aF) {
		return A3(
			$author$project$Battle$evaluateLordCasualities,
			w,
			A3($author$project$Battle$sumTroopsDamage, army, ter, aF),
			dF);
	});
var $author$project$Battle$evaluateLordBattle = F2(
	function (bS, ter) {
		...
		var newDefender = _Utils_update(
			tempDefender,
			{
				entity: A5($author$project$Battle$evaluateBattle, tempDefender.entity, bS.attacker.entity.army, ter, 1, 1)
			});
		var newAttacker = _Utils_update(
			tempAttacker,
			{
				entity: A5($author$project$Battle$evaluateBattle, tempAttacker.entity, bS.defender.entity.army, ter, 1, 1)
			});
...
var $author$project$Entities$getAttackerBonus = function (s) {
	if (s.$ === 'Nothing') {
		return 1;
	} else {
		var x = s.a;
		return 1 + (A2($author$project$Building$resolveBonusFromBuildings, x.buildings, $author$project$Building$Barracks) / 100);
	}
};
	...
	function (bS, settle, ter) {
		...
		var newSettle = _Utils_update(
			transferedSettle,
			{
				entity: A5(
					$author$project$Battle$evaluateBattle,
					transferedSettle.entity,
					bS.attacker.entity.army,
					ter,
					A2($author$project$Entities$getSettlementBonus, settle, bS.defender.land),
					$author$project$Entities$getAttackerBonus(
						$author$project$Entities$getLordCapital(bS.defender.land)))
			});
		var defenderCasualties = A2($author$project$Battle$calculateEntityCasualties, transferedSettle.entity.army, newSettle.entity.army);
		return A6(
...
var $author$project$AI$attackLord = F4(
	function (ai, l, t, ls) {
		return A2(
			$author$project$Battle$applyBattleAftermath,
			ls,
			A2(
				$author$project$Battle$skipBattle,
				t,
				A2($author$project$Battle$getLordBattleStats, ai.lord, l)));
	});
var $author$project$Entities$setSettlement = F2(
	function (newS, l) {
		var updatedSettlements = A2(
			$elm$core$List$map,
			function (s) {
				return _Utils_eq(s.entity.name, newS.entity.name) ? newS : s;
			},
			l.land);
		return _Utils_update(
			l,
			{land: updatedSettlements});
	});
var $author$project$Entities$setSettlementRecruits = F2(
	function (army, s) {
		return _Utils_update(
			s,
			{recruitLimits: army});
	});
var $author$project$Entities$sumArmyBuyCost = function (a) {
	return A3(
		$elm$core$Dict$foldl,
		F3(
			function (k, v, cost) {
				return ($author$project$Troops$troopCost(
					$author$project$Troops$intToTroopType(k)) * v) + cost;
			}),
		0,
		a);
};
var $author$project$Entities$recruitTroops = F3(
	function (recruitDict, l, s) {
		var _v0 = A3(
			$elm$core$Dict$foldl,
			F3(
				function (k, v, _v1) {
					...
					var recruits = _v1.b;
					return _Utils_Tuple2(
						A3($author$project$Troops$updateTroopsFrom, lordArmy, k, v),
						A3($author$project$Troops$updateTroopsFrom, recruits, k, -v));
				}),
			_Utils_Tuple2(l.entity.army, s.recruitLimits),
			recruitDict);
		var newLArmy = _v0.a;
		var newSRecruits = _v0.b;
		return A2(
			$author$project$Entities$setSettlement,
			A2($author$project$Entities$setSettlementRecruits, newSRecruits, s),
			_Utils_update(
				l,
				{
					entity: A2($author$project$Entities$updateEntitiesArmy, newLArmy, l.entity),
					gold: l.gold - $author$project$Entities$sumArmyBuyCost(recruitDict)
				}));
	});
var $author$project$Event$Event = F3(
	function (header, text, eventType) {
		return {eventType: eventType, header: header, text: text};
	});
var $author$project$Event$Important = {$: 'Important'};
var $author$project$Event$Minor = {$: 'Minor'};
var $author$project$AI$showBasicActionActivity = F2(
	function (ai, action) {
		switch (action.$) {
			case 'AttackLord':
				var l = action.a;
				return A3($author$project$Event$Event, ai.lord.entity.name, ai.lord.entity.name + (' attacked ' + (l.entity.name + '!')), $author$project$Event$Important);
			case 'HireTroops':
				var s = action.b;
				return A3($author$project$Event$Event, ai.lord.entity.name, ai.lord.entity.name + (' recruited troops from ' + s.entity.name), $author$project$Event$Minor);
			case 'SwapTroops':
				var s = action.b;
				return A3($author$project$Event$Event, ai.lord.entity.name, ai.lord.entity.name + (' swapped troops with ' + s.entity.name), $author$project$Event$Minor);
			case 'SiegeSettlement':
				var s = action.a;
				return A3($author$project$Event$Event, ai.lord.entity.name, ai.lord.entity.name + (' sieged  ' + (s.entity.name + '!')), $author$project$Event$Important);
			default:
				var b = action.b;
				return A3(
					$author$project$Event$Event,
					ai.lord.entity.name,
					ai.lord.entity.name + (' improved ' + (b.name + (' to level ' + $elm$core$String$fromInt(b.level + 1)))),
...
var $author$project$AI$siegeSettlement = F4(
	function (ai, s, t, ls) {
		return A3(
			$author$project$MaybeExt$foldMaybe,
			function (b) {
				return A2(
					$author$project$Battle$applyBattleAftermath,
					ls,
					A2($author$project$Battle$skipBattle, t, b));
			},
			ls,
			A3($author$project$Battle$getBattleSiegeStats, ai.lord, ls, s));
	});
var $author$project$Entities$swapLordTroopsWithSettlement = F3(
	function (l, s, dict) {
		var _v0 = A3(
			$elm$core$Dict$foldl,
			F3(
			...
			_Utils_Tuple2(l.entity.army, s.entity.army),
			dict);
		var newLArmy = _v0.a;
		var newSArmy = _v0.b;
		var newS = _Utils_update(
			s,
			{
				entity: A2($author$project$Entities$updateEntitiesArmy, newSArmy, s.entity)
			});
		return A2(
			$author$project$Entities$setSettlement,
			newS,
...
var $author$project$Entities$upgradeBuilding = F3(
	function (l, b, s) {
		return _Utils_update(
			l,
			{
				gold: l.gold - A2($author$project$Building$upgradeBuildingInfoCost, b.buildingType, b.level),
				land: A3($author$project$Entities$updateSettlementBuildings, l.land, s.entity.name, b.buildingType)
			});
	});
var $author$project$AI$executeBasicAiAction = F6(
	function (ai, destination, action, tileOnPos, moveTowards, lordList) {
		if (_Utils_eq(ai.lord.entity.position, destination)) {
			var newLords = function () {
				switch (action.$) {
					case 'SiegeSettlement':
						var s = action.a;
						return A4(
							$author$project$AI$siegeSettlement,
							ai,
							s,
					...
					case 'SwapTroops':
						...
						var s = action.b;
						return A2(
							$author$project$Entities$Lords$replaceAi,
							lordList,
							_Utils_update(
								ai,
								{
									lord: A3($author$project$Entities$swapLordTroopsWithSettlement, ai.lord, s, dict)
								}));
					case 'HireTroops':
						var dict = action.a;
						var s = action.b;
						return A2(
							...
							_Utils_update(
								ai,
								{
									lord: A3($author$project$Entities$recruitTroops, dict, ai.lord, s)
								}));
					default:
						var s = action.a;
						var b = action.b;
						return A2(
							...
							_Utils_update(
								ai,
								{
									lord: A3($author$project$Entities$upgradeBuilding, ai.lord, b, s)
								}));
				}
			}();
			return _Utils_Tuple2(
				newLords,
				$elm$core$Maybe$Just(
					A2($author$project$AI$showBasicActionActivity, ai, action)));
		} else {
			return _Utils_Tuple2(lordList, $elm$core$Maybe$Nothing);
		}
	});
var $author$project$AI$updateAi = F5(
	function (ai, action, tileOnPos, moveTowards, lordList) {
		switch (action.$) {
			case 'EndRound':
				return _Utils_Tuple2(lordList, $elm$core$Maybe$Nothing);
			case 'GoSomeWhere':
				...
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							ai,
							{
								lord: A2(moveTowards, ai.lord, p)
							})),
					$elm$core$Maybe$Nothing);
			default:
				var basicAction = action.a;
				var destination = $author$project$AI$AIActionDistanceHandler$getBasicActionDestination(basicAction);
				var movedAI = _Utils_update(
					ai,
					{
						lord: A2(moveTowards, ai.lord, destination)
					});
				return A6(
					$author$project$AI$executeBasicAiAction,
					movedAI,
					destination,
					basicAction,
					tileOnPos,
					moveTowards,
					A2($author$project$Entities$Lords$replaceAi, lordList, movedAI));
		}
	});
var $author$project$Main$playAiTurn = function (m) {
	var _v0 = A2(
		$author$project$ListExt$getElementAt,
		m.playersTurn - 1,
		$author$project$Entities$Lords$getAis(m.lords));
	if (_v0.$ === 'Nothing') {
		return $author$project$Main$endAnyRound(m);
	} else {
		var ai = _v0.a;
		var action = A4(
			$author$project$AI$getAiAction,
			ai,
			$author$project$PathAgent$lordsTurnToReachDestination(m.map),
			$author$project$PathAgent$canMoveTowardsInTurn(m.map),
			A2($author$project$Entities$Lords$getLordsExcept, m.lords, ai.lord));
		if (action.$ === 'EndRound') {
			return $author$project$Main$endAnyRound(
				_Utils_update(
					m,
					{
						lords: A2(
							...
							m.lords,
							A2(
								$author$project$AI$setLord,
								ai,
								$author$project$Main$endRoundForLord(ai.lord)))
					}));
		} else {
			var other = action;
			var _v2 = A5(
				$author$project$AI$updateAi,
				ai,
				other,
				A2($author$project$OperatorExt$flip, $author$project$Map$getTerrainForPoint, m.map),
				$author$project$PathAgent$moveLordOnPath(m.map),
				m.lords);
			var newLords = _v2.a;
			var actionEvent = _v2.b;
			return _Utils_update(
				m,
				{
					event: A3(
						$author$project$MaybeExt$foldMaybe,
						function (event) {
							return A2($author$project$Event$appendEvent, m.event, event);
						},
						m.event,
						actionEvent),
					lords: newLords
...
var $author$project$Entities$Lords$getLordIndex = F2(
	function (ls, toCheck) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (l, index) {
					return _Utils_eq(toCheck.entity.name, l.entity.name) ? index : (index + 1);
				}),
			0,
			$author$project$Entities$Lords$lordListToList(ls));
	});
var $author$project$Entities$hasCapital = function (l) {
	return A3(
		$elm$core$List$foldr,
		F2(
			function (s, r) {
				return r || _Utils_eq(s.settlementType, $author$project$Entities$Model$Castle);
			}),
		false,
		l.land);
};
var $author$project$Entities$Lords$updateNpcs = F2(
	function (_v0, ais) {
		var l = _v0.a;
		return A2($author$project$Entities$Lords$Cons, l, ais);
	});
var $author$project$Main$removeLordsWithoutCapital = function (lordList) {
	return A2(
		$author$project$Entities$Lords$updateNpcs,
		lordList,
		A2(
			$elm$core$List$filter,
			function (ai) {
				return $author$project$Entities$hasCapital(ai.lord);
			},
			$author$project$Entities$Lords$getAis(lordList)));
};
var $author$project$Main$removeLordsWithoutCapitalFromModel = function (m) {
	var removedLords = A2(
		$elm$core$List$filter,
		function (ai) {
			return !$author$project$Entities$hasCapital(ai.lord);
	...
	var newTurnIndex = A3(
		...
		F2(
			function (l, index) {
				return (_Utils_cmp(
					A2($author$project$Entities$Lords$getLordIndex, m.lords, l),
					m.playersTurn) > 0) ? (index - 1) : index;
			}),
		m.playersTurn,
		A2(
			$elm$core$List$map,
	...
	return _Utils_update(
		m,
		{
			lords: $author$project$Main$removeLordsWithoutCapital(m.lords),
			playersTurn: newTurnIndex
		});
};
var $author$project$Main$BattleView = function (a) {
	return {$: 'BattleView', a: a};
};
var $author$project$Battle$battleFleeTroopLoss = 0.3;
...
var $author$project$Battle$fleeBattle = F2(
	function (ls, bS) {
		...
		var newEnemy = _Utils_update(
			tempEnemy,
			{gold: tempEnemy.gold + (tempPlayer.gold / 2)});
		return A2(
			$author$project$Entities$Lords$updateLord,
			newEnemy,
			A2($author$project$Entities$Lords$updateLord, newPlayer, ls));
	});
...
var $author$project$Ports$transitSoundToMusic = _Platform_outgoingPort(
	'transitSoundToMusic',
	function ($) {
		var a = $.a;
		var b = $.b;
		...
		switch (msg.$) {
			case 'StartSkirmish':
				...
				return _Utils_Tuple2(
					...
					$author$project$Ports$playSound('Kampfgeklirre2Sec'));
			case 'SkipSkirmishes':
				var bS = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							lords: A2($author$project$Battle$fleeBattle, model.lords, bS)
						}),
					$author$project$Main$getBattleAftermathSound(bS));
			default:
				var bS = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							gameState: $author$project$Main$GameSetup($author$project$Main$GameMenue),
							lords: A2($author$project$Battle$applyBattleAftermath, model.lords, bS)
						}),
					$author$project$Main$getBattleAftermathSound(bS));
		}
	});
...
var $author$project$ListExt$removeElementAt = F2(
	function (i, l) {
		return A3(
			$elm$core$List$foldr,
			F2(
				function (a, _v0) {
					var r = _v0.a;
					var index = _v0.b;
					return _Utils_eq(index, i) ? _Utils_Tuple2(r, index + 1) : _Utils_Tuple2(
...
var $author$project$Event$removeEvent = F2(
	function (e, i) {
		return _Utils_update(
			e,
			{
				events: A2($author$project$ListExt$removeElementAt, i, e.events)
			});
	});
...
var $author$project$Entities$factionToLord = F2(
	function (f, l) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (x) {
					return _Utils_eq(x.entity.faction, f);
				},
				l));
	});
		...
		switch (ma.$) {
			...
			case 'SettlementMsg':
				...
				switch (msg.$) {
					case 'ViewSettlement':
						var _v2 = A2(
							$author$project$Entities$factionToLord,
							settlement.entity.faction,
							$author$project$Entities$Lords$lordListToList(model.lords));
						if (_v2.$ === 'Nothing') {
							return $author$project$Main$emptyCmd(
								_Utils_update(
									model,
							...
							return $author$project$Main$emptyCmd(
								_Utils_update(
									...
									{
										gameState: $author$project$Main$GameSetup(
											A3($author$project$Main$SettlementView, lord, settlement, $author$project$Msg$RestrictedView))
									}));
						}
					...
					default:
						var defender = A2(
							...
							$author$project$Entities$Lords$lordListToList(model.lords));
						if (defender.$ === 'Nothing') {
							return $author$project$Main$emptyCmd(model);
						} else {
							var l = defender.a;
							return _Utils_Tuple2(
								_Utils_update(
			...
			default:
				...
				var _v4 = A3($author$project$Main$getPathTo, player.entity.position, p, model.map);
				if (_v4.$ === 'Nothing') {
					return $author$project$Main$emptyCmd(model);
				} else {
					var path = _v4.a;
					var _v5 = A3($author$project$PathAgent$moveAlongPath, path, player.entity.position, player.agent);
					var usedMove = _v5.a;
					var point = _v5.b;
						...
						_Utils_update(
							model,
							{
								lords: A2(
									$author$project$Entities$Lords$Cons,
									newPlayer,
									$author$project$Entities$Lords$getAis(model.lords))
							}));
				}
		}
	});
...
var $author$project$Ports$updateVolume = _Platform_outgoingPort('updateVolume', $elm$json$Json$Encode$int);
			...
			case 'ChangeVolume':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{volume: vol}),
					$author$project$Ports$updateVolume(vol));
			case 'ShowMenue':
				return $author$project$Main$emptyCmd(
					_Utils_update(
						model,
...
var $author$project$Entities$Lords$updatePlayer = F2(
	function (_v0, np) {
		var ps = _v0.b;
		return A2($author$project$Entities$Lords$Cons, np, ps);
	});
...
var $author$project$Main$updateMultipleTroopStats = F4(
	function (l, s, u, m) {
		var newSettle = A2(
			...
			$author$project$Entities$Lords$getPlayer(l).land,
			s.entity.name);
			...
			return _Utils_update(
				m,
				{
					gameState: $author$project$Main$GameSetup(
						A3(
							$author$project$Main$SettlementView,
							$author$project$Entities$Lords$getPlayer(l),
							x,
							u)),
					lords: l
				});
		...
		switch (msg.$) {
			case 'BuyTroops':
				...
				return A4(
					...
					A2(
						$author$project$Entities$Lords$updatePlayer,
						model.lords,
						A3(
							$author$project$Entities$buyTroops,
							$author$project$Entities$Lords$getPlayer(model.lords),
							t,
							s)),
					s,
			...
			case 'BuyAllTroops':
				...
				return A4(
					...
					A2(
						...
						model.lords,
						A2(
							$author$project$Entities$buyAllTroops,
							$author$project$Entities$Lords$getPlayer(model.lords),
							s)),
					s,
					$author$project$Msg$RecruitView,
...
var $author$project$Main$TroopView = function (a) {
	return {$: 'TroopView', a: a};
};
...
var $author$project$Main$updateTroopOverView = F2(
	function (model, msg) {
		if (msg.$ === 'TroopActionMsg') {
			return _Utils_update(
				model,
				{
					gameState: $author$project$Main$GameSetup(
						$author$project$Main$TroopView(
							$author$project$Main$getPlayer(model)))
				});
		} else {
			var t = msg.a;
			var newLords = A2(
				...
				model.lords,
				A2(
					$author$project$Entities$disbandTroops,
					$author$project$Entities$Lords$getPlayer(model.lords),
					t));
			return _Utils_update(
				model,
				{
					gameState: $author$project$Main$GameSetup(
						$author$project$Main$TroopView(
							$author$project$Entities$Lords$getPlayer(newLords))),
					lords: newLords
				});
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var other = msg;
				var _v1 = function () {
					if ($author$project$Main$isPlayersTurn(model)) {
						switch (other.$) {
							case 'EndRound':
								return $author$project$Main$emptyCmd(
									$author$project$Main$endAnyRound(
										_Utils_update(
											model,
											{
							...
							case 'MapTileAction':
								var action = other.a;
								return A2($author$project$Main$updateMaptileAction, model, action);
							case 'TroopAction':
								var tomsg = other.a;
								return $author$project$Main$emptyCmd(
									A2($author$project$Main$updateTroopOverView, model, tomsg));
							case 'Click':
								var p = other.a;
								return $author$project$Main$emptyCmd(
									_Utils_update(
						...
						if (msg.$ === 'AiRoundTick') {
							return $author$project$Main$emptyCmd(
								$author$project$Main$playAiTurn(model));
						} else {
							return $author$project$Main$emptyCmd(
								_Utils_update(
									model,
									{errorMsg: 'Its not your turn'}));
						}
					}
				}();
				var newModel = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					$author$project$Main$checkIfGameEnded(
						$author$project$Main$removeLordsWithoutCapitalFromModel(newModel)),
					cmd);
		}
	});
...
var $author$project$Main$allSettlements = function (m) {
	return $elm$core$List$concat(
		A2(
			...
			$author$project$Entities$Lords$lordListToList(m.lords)));
};
...
var $author$project$MapData$pathZIndex = 11;
...
var $author$project$Templates$MapActionTemplate$getEntityTroopsByMapTile = F2(
	function (svga, ff) {
		switch (svga.$) {
			case 'LordMsg':
				var lmsg = svga.a;
				...
				if (lmsg.$ === 'ViewLord') {
					return A3(
						$author$project$OperatorExt$ternary,
						ff(lord.entity.faction),
						lord.entity.army,
						$author$project$Troops$emptyTroops);
				} else {
					return $author$project$Troops$emptyTroops;
				}
			case 'SettlementMsg':
				var smsg = svga.a;
				var settlement = svga.b;
				if (smsg.$ === 'ViewSettlement') {
					return A3(
						$author$project$OperatorExt$ternary,
						ff(settlement.entity.faction),
...
var $author$project$Templates$MapActionTemplate$combineTroopDicts = F3(
	function (a, l, ff) {
		combineTroopDicts:
		while (true) {
			if (!l.b) {
				...
				var $temp$a = A2(
					$author$project$Troops$mergeTroops,
					a,
					A2($author$project$Templates$MapActionTemplate$getEntityTroopsByMapTile, x, ff)),
					$temp$l = xs,
					$temp$ff = ff;
				a = $temp$a;
				l = $temp$l;
				ff = $temp$ff;
				continue combineTroopDicts;
			}
		}
	});
var $author$project$DictExt$foldlOverKeys = F4(
	function (f1, f2, e, d) {
		return A2(
			$elm$core$List$foldl,
			F2(
...
var $author$project$Troops$troopKeyList = A2($elm$core$List$map, $author$project$Troops$troopTypeToInt, $author$project$Troops$troopTypeList);
...
var $author$project$Templates$MapActionTemplate$getTroopOverviewData = function (t) {
	return A5(
		$author$project$DictExt$foldlOverKeys,
		F3(
			function (k, v, r) {
				return A2(
					$elm$core$List$cons,
...
var $author$project$Templates$MapActionTemplate$generateTroopOverview = F2(
	function (pf, actions) {
		var playerTroops = A3(
			$author$project$Templates$MapActionTemplate$combineTroopDicts,
			$author$project$Troops$emptyTroops,
			actions,
			function (f) {
				return _Utils_eq(f, pf);
			});
		var enemyTroops = A3(
			$author$project$Templates$MapActionTemplate$combineTroopDicts,
			$author$project$Troops$emptyTroops,
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('map-troop-overview')
				]),
			_Utils_ap(
				A2(
					$elm$core$List$cons,
					A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('map-troop-overview-header')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Enemy troops on map tile')
							])),
					$author$project$Templates$MapActionTemplate$getTroopOverviewData(enemyTroops)),
				A2(
					$elm$core$List$cons,
					A2(
						$elm$html$Html$span,
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Your troops on map tile')
							])),
					$author$project$Templates$MapActionTemplate$getTroopOverviewData(playerTroops))));
	});
var $author$project$Templates$MapActionTemplate$generateMapActionTemplate = F3(
	function (p, player, dict) {
		var actions = function () {
			if (p.$ === 'Nothing') {
				return _List_Nil;
			} else {
				var x = p.a;
				return A2($author$project$MapAction$actionsOnPoint, x, dict);
			}
		}();
		return A2(
			$elm$html$Html$div,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('map-action-menu-body')
								]),
							A2($elm$core$List$map, $author$project$Templates$MapActionTemplate$generateMapActionButtons, actions))
						])),
					A2($author$project$Templates$MapActionTemplate$generateTroopOverview, player.entity.faction, actions)
				]));
	});
var $author$project$Main$buildMapActionTemplate = F2(
	function (model, allClickActions) {
		if ($author$project$Main$isPlayersTurn(model)) {
			return A3(
				$author$project$Templates$MapActionTemplate$generateMapActionTemplate,
				model.selectedPoint,
				$author$project$Main$getPlayer(model),
				allClickActions);
		} else {
			var lordName = A3(
				...
				'Unkown Enemy' + ($elm$core$String$fromInt(model.playersTurn) + $elm$core$String$fromInt(
					$elm$core$List$length(
						$author$project$Entities$Lords$lordListToList(model.lords)))),
				A2(
					$author$project$ListExt$getElementAt,
			...
			return A2(
				...
				A2(
					...
					A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('It`s ' + (lordName + '`s turn'))
							])),
					_List_Nil));
		}
	});
...
var $author$project$Templates$BattleTemplate$generateSettlementBonus = F2(
	function (bS, ter) {
		var _v0 = bS.settlement;
		if (_v0.$ === 'Nothing') {
			return _List_fromArray(
		...
		_List_fromArray(
			[
				...
				A3(
					...
					'My lord, we were victorious, we destroyed them!'))
			])) : A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
				...
				[
					...
					_Utils_ap(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$src(
												'./assets/images/map/' + ($elm$core$String$toLower(
													$author$project$Map$terrainToName(ter)) + '_icon_color.png'))
											]),
										_List_Nil),
										A2(
										$elm$html$Html$span,
						...
						_Utils_ap(
							...
							A2($author$project$Templates$BattleTemplate$generateSettlementBonus, bS, ter)))),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
...
var $author$project$DictExt$mergeKeys = F8(
	function (f1, f2, f3, f4, d1, d2, keys, r) {
		mergeKeys:
		while (true) {
			if (!keys.b) {
				return r;
				...
				var _v1 = _Utils_Tuple2(
					A2($elm$core$Dict$get, k, d1),
					A2($elm$core$Dict$get, k, d2));
				if (_v1.a.$ === 'Nothing') {
					if (_v1.b.$ === 'Nothing') {
						var _v2 = _v1.a;
						var _v3 = _v1.b;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					A8(
						$author$project$DictExt$mergeKeys,
						F3(
							function (k, v1, r) {
								return A2(
									$elm$core$List$cons,
...
var $author$project$Templates$EndTemplate$losingDesc = 'Your castle was taken, you are dead.';
var $author$project$Templates$EndTemplate$losingTitle = 'We have lost!';
var $author$project$Templates$EndTemplate$winningDesc = 'My lord you have smited your last enemy, the kingdom is yours.';
...
var $author$project$Msg$BuyAllTroops = function (a) {
	return {$: 'BuyAllTroops', a: a};
};
...
var $author$project$Templates$SettlementTemplate$checkBuildingCapabilities = function (s) {
	return _Utils_eq(s.settlementType, $author$project$Entities$Model$Castle) ? A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Msg$SettlementAction(
					$author$project$Msg$UIMsg(
						$author$project$Msg$ShowBuildings(s))))
			]),
		_List_fromArray(
			[
				A2(
		...
		switch (b.$) {
			case 'Quarters':
				return '+' + ($elm$core$String$fromFloat(
					i * $author$project$Building$buildingToBonus(b)) + ' recruit space in all settlements');
			case 'Barracks':
				return '+' + ($elm$core$String$fromFloat(
					i * $author$project$Building$buildingToBonus(b)) + '% attacker-bonus in offensive battles');
			default:
				return '+' + ($elm$core$String$fromFloat(
					i * $author$project$Building$buildingToBonus(b)) + '% defender-bonus in the capital ');
		}
	});
					...
					[
						...
						A3(
							...
							'Cost: ' + $elm$core$String$fromFloat(
								A2($author$project$Building$upgradeBuildingInfoCost, b.buildingType, i - 1)),
							''))
					]))
			]));
};
var $author$project$Templates$SettlementTemplate$validateBuildingUpgrade = F2(
	function (b, l) {
		return !(((l.gold - $author$project$Building$upgradeBuildingCost(b)) > 0) && (b.level <= 2));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('building-icon-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('./assets/images/buildings/' + (b.name + '.png'))
							]),
						_List_Nil)
					])),
				A2(
...
var $author$project$Entities$getSettlementTroopsRecruitLimit = F3(
	function (s, l, t) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
			function (c) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var quarters = _v0.a;
			return A3($author$project$Entities$settlementTroopsRecruitLimit, s, quarters.level, t);
		}
	});
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'[' + ($elm$core$String$fromInt(sAmount) + ('/' + ($elm$core$String$fromInt(
								A3($author$project$Entities$getSettlementTroopsRecruitLimit, s, l, t)) + ']'))))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('troop-recruit-button-text')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('+')
...
var $author$project$Templates$SettlementTemplate$validateSettlement = F3(
	function (pF, l, s) {
		return _List_fromArray(
			[
				A2(
...
var $author$project$Templates$SettlementTemplate$settlementStateToAction = F4(
	function (pF, lord, settlement, uistate) {
		switch (uistate.$) {
			case 'StandardView':
				return _List_fromArray(
					[
						...
						$author$project$Templates$SettlementTemplate$checkBuildingCapabilities(settlement),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
			...
			case 'RestrictedView':
				return _Utils_ap(
					A3($author$project$Templates$SettlementTemplate$validateSettlement, pF, lord, settlement),
					_List_fromArray(
						[
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											'Income: +' + ($elm$core$String$fromFloat(
...
var $author$project$Templates$SettlementTemplate$generateSettlementModalTemplate = F4(
	function (pF, lord, settlement, uistate) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$src(
													'./assets/images/profiles/' + $author$project$Entities$factionToImage(settlement.entity.faction)),
							...
							A4($author$project$Templates$SettlementTemplate$settlementStateToAction, pF, lord, settlement, uistate)),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src(
											'./assets/images/illustrations/' + ($elm$core$String$toLower(
												$author$project$Entities$getSettlementNameByType(settlement.settlementType)) + '.png'))
										]),
									_List_Nil)
								]))
						]))
...
var $author$project$Msg$TroopAction = function (a) {
	return {$: 'TroopAction', a: a};
};
var $author$project$Msg$TroopArmyMsg = function (a) {
	return {$: 'TroopArmyMsg', a: a};
};
var $author$project$Templates$TroopTemplate$troopToDisbandHtml = F2(
	function (t, v) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('disband-troop-container')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(v) + ('  ' + $author$project$Troops$troopName(t)))
						])),
					A2(
					$elm$html$Html$button,
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Msg$TroopAction(
								$author$project$Msg$TroopArmyMsg(t))),
							$elm$html$Html$Attributes$class(
							A3($author$project$OperatorExt$ternary, v > 0, 'disband-button tooltip', 'disband-button troop-disabled-button')),
							$elm$html$Html$Attributes$disabled(v <= 0)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Disband 5 units')
										]))
								]))
						]))
				]));
	});
var $author$project$Templates$TroopTemplate$generateTroopTemplate = function (l) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('troop-modal')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('troop-modal-close-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('troop-modal-close'),
										$elm$html$Html$Events$onClick($author$project$Msg$CloseModal)
									]),
								_List_fromArray(
									[
						...
						A2(
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('troop-header')
									]),
								_List_fromArray(
									[
										A2(
								...
								F3(
									function (k, v, r) {
										return A2(
											$elm$core$List$cons,
											A2(
												$author$project$Templates$TroopTemplate$troopToDisbandHtml,
												$author$project$Troops$intToTroopType(k),
												v),
											r);
									}),
	...
	if (_v0.$ === 'GameSetup') {
		...
		switch (uistate.$) {
			case 'SettlementView':
				...
				var u = uistate.c;
				return A4(
					$author$project$Templates$SettlementTemplate$generateSettlementModalTemplate,
					$author$project$Main$getPlayer(model).entity.faction,
					l,
					s,
					u);
			case 'LordView':
			...
			case 'TroopView':
				var l = uistate.a;
				return $author$project$Templates$TroopTemplate$generateTroopTemplate(l);
			default:
...
var $author$project$Templates$EventTemplate$generateEventComponent = F2(
	function (index, e) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					_List_fromArray(
						[
							...
							$author$project$Msg$EventAction(
								$author$project$Msg$DeleteEvent(index))),
					...
					F2(
						function (e, _v0) {
							...
							return _Utils_Tuple2(
								A2(
									$elm$core$List$cons,
									A2($author$project$Templates$EventTemplate$generateEventComponent, i, e),
									r),
								i + 1);
						}),
					_Utils_Tuple2(_List_Nil, 0),
...
var $author$project$Msg$ChangeVolume = function (a) {
	return {$: 'ChangeVolume', a: a};
};
var $author$project$Templates$HeaderTemplate$resolveOnChangeMsg = function (str) {
	return $author$project$Msg$MenueAction(
		$author$project$Msg$ChangeVolume(
			A2(
				$elm$core$Maybe$withDefault,
				0,
...
var $author$project$Templates$HeaderTemplate$headerSettingsTemplate = function (vol) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('tooltiptext sound-tooltip')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$elm$core$String$fromInt(vol)),
									$elm$html$Html$Events$onInput($author$project$Templates$HeaderTemplate$resolveOnChangeMsg)
								]),
							_List_Nil),
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											'Current volume: ' + ($elm$core$String$fromInt(vol) + '%'))
										]))
								]))
						]))
				])),
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('tooltiptext event-tooltip')
										]),
									_List_fromArray(
										[
...
var $author$project$Msg$TroopActionMsg = {$: 'TroopActionMsg'};
...
var $author$project$Templates$HeaderTemplate$headerTroopTemplate = function (lord) {
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('troop-info-icon')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Msg$TroopAction($author$project$Msg$TroopActionMsg))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Disband troops')
						]))
				]))
		]);
};
...
var $author$project$Templates$HeaderTemplate$generateHeaderTemplate = F3(
	function (vol, lord, date) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$author$project$Templates$HeaderTemplate$headerSettingsTemplate(vol))
				]));
	});
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							A2($author$project$Main$buildMapActionTemplate, model, allClickActions),
							A2(
							$elm$html$Html$div,
							_List_Nil,
							_List_fromArray(
...
var $author$project$Entities$validatePlayerName = function (v) {
	return A2(
		$elm$core$List$any,
		function (x) {
...
var $author$project$Templates$StartTemplate$resolveOnChangeMsg = function (str) {
	return $author$project$Msg$MenueAction(
		$author$project$Msg$ChangeName(str));
};
var $author$project$Templates$StartTemplate$startCampaign = function (v) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
				...
				[
					...
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Events$onInput($author$project$Templates$StartTemplate$resolveOnChangeMsg)
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									$author$project$Templates$StartTemplate$generateInputMsg(v)
								])),
							A2(
							$elm$html$Html$div,
							_List_fromArray(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Events$onClick(
													$author$project$Msg$MenueAction(
														$author$project$Msg$StartGame(v))),
													$elm$html$Html$Attributes$class(
													A3(
														$author$project$OperatorExt$ternary,
														$author$project$Entities$validatePlayerName(v) || (v === ''),
														'start-buttons start-campaign-button troop-disabled-button',
														'start-buttons start-campaign-button')),
													$elm$html$Html$Attributes$disabled(
													$author$project$Entities$validatePlayerName(v) || (v === ''))
												]),
											_List_fromArray(
		...
		return A2(
			...
			function () {
				if (state.$ === 'Menue') {
					...
					return _Utils_ap(
						A2($elm$core$List$map, $author$project$Main$addStylesheet, $author$project$Main$stylessheets),
						$author$project$Templates$StartTemplate$startCampaign(v));
				}
			}());
	});
			...
			[
				...
				if (_v0.$ === 'GameSetup') {
					...
					if (uistate.$ === 'MainMenue') {
						var state = uistate.a;
						return A2($author$project$Main$setMenueView, state, model.playerInput);
					} else {
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return A2($author$project$Main$startGame, 'Jan von Haskell', $elm$core$Platform$Cmd$none);
		},
		subscriptions: function (m) {
			return $author$project$Main$tickSub(m);
		},
