...
headerSettingsTemplate vol =
    [ div [ Html.Attributes.class "page-setting-container tooltip" ]
        ...
        , div [ Html.Attributes.class "tooltiptext sound-tooltip" ]
            [ input [ Html.Attributes.type_ "range", Html.Attributes.min "0", Html.Attributes.max "10", Html.Attributes.value (String.fromInt vol), Html.Events.onInput resolveOnChangeMsg ] []
            , div [ Html.Attributes.style "text-align" "center" ]
                [ span [ ] [ Html.text ("Current volumne: " ++ String.fromInt (vol * 10) ++ "%") ] ]
            ]
        ]
